...
Write features/[feature-name]-[number]/plan.md with both phases as distinct sections. Do not restate intent. Plan informs implementation; intent describes purpose.

Present the written plan to the user for review. Revise until it is sound.

Commit the completed plan.md to the working branch.
