...
When the changes are clear, write the updated `declaration.md` with all six sections: `## What`, `## Why`, `## For whom`, `## Out of scope`, `## Shape (revisable)`, `## Roadmap (revisable)`. Present it to the user for review. Revise until it says what they meant.
