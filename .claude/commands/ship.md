...
4. **On success: close out.** Unsubscribe from PR activity and deliver the final report: what shipped, the verified release state, risks acknowledged, deviations, and any spec-authoring lessons not already committed (present them for the owner to apply).
